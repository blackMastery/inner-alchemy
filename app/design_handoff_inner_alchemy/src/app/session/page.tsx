        ...
        <div className="rounded-[18px] border border-rule-2 bg-linen-warm px-10 py-9 max-md:p-[26px]">
          ...
          <ul className="flex flex-col gap-2.5 text-[14.5px] text-muted">
            {[
              ...
              <li key={line} className="flex gap-2.5"><span className="text-clay">✦</span><span>{line}</span></li>
            ))}
          </ul>
        </div>
      </section>
        ...
        {SESSION_TIMELINE.map((step, i) => (
          ...
          >
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.12em] text-muted-2">{step.span}</p>
            </div>
            <div>
