        ...
        <div className="grid grid-cols-[1.2fr_0.8fr_0.8fr] gap-12 border-b border-rule/15 pb-10 max-md:grid-cols-1 max-md:gap-8">
          <div>
            <p className="mb-1.5 font-display text-2xl text-cream-2">
              Inner <span className="text-sm text-clay-light">✦</span> Alchemy
            </p>
            <p className="mb-5 text-[9.5px] uppercase tracking-[0.24em] text-muted-2">
              Institution · Life Coaching &amp; Hypnotherapy Services
            </p>
            <p className="max-w-[40ch] text-[13px] leading-relaxed text-muted-dark">
              Online coaching and quantum healing sessions. Georgetown, Guyana — serving clients worldwide.
            </p>
          </div>

          <div className="flex flex-col gap-3 text-sm">
            <p className="mb-1 text-[11px] uppercase tracking-[0.16em] text-muted-2">Explore</p>
          ...
          <div className="flex flex-col items-start gap-3 text-sm">
            <p className="mb-1 text-[11px] uppercase tracking-[0.16em] text-muted-2">Begin</p>
            <BookingButton variant="sand" size="sm">Book a free discovery call</BookingButton>
            <span className="text-cream">hello@inneralchemy.example</span>
          </div>
        </div>

        <p className="mt-7 max-w-[90ch] text-xs leading-[1.8] text-[#7D7365]">
