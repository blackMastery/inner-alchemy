  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between gap-4">
        ...
        <span className={`whitespace-nowrap font-bold ${dark ? "text-clay-light" : "text-clay"}`}>{p.price}</span>
      </div>
      <p className={`text-[12.5px] uppercase tracking-[0.1em] ${dark ? "text-clay-light" : "text-sage"}`}>{p.duration}</p>
    ...
    <>
      ...
      {[
        ...
        <section key={tier} className="mx-auto max-w-[1120px] px-8 pb-14 max-md:px-[22px]">
          <h2 className="mb-5 text-[13px] font-bold uppercase tracking-[0.16em] text-clay">{title}</h2>
